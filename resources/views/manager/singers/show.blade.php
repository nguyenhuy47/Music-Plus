...
@section('content')
    ...
    <div class="bg-img"
        ...
        <div class="lammonen row mx-0" style="background-color: rgba(0,0,0,.65);">
            <div class="col-3">
                <img src="{{asset('/storage/images/singer/'.$singer->image)}}" width="288" height="288"
                     alt="song-thumbnail" class="img img-responsive p-4">
            </div>
            <div class="col-9">
    ...
    <div>
        <table class="table">
            ...
            <tr class="text-center">
                <td colspan="2"><b>DANH SÁCH BÀI HÁT</b><a class="float-right"
                                                           href="{{ route('singers.playAll', $singer->id) }}">{{'Nghe tất cả  '}}
