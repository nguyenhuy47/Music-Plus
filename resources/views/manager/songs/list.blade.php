                ...
                <table class="table">
                    ...
                    @foreach($songs as $song)
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-default" href="{{ route('songs.edit', $song->id) }}" title="Sửa"><span class="fas fa-edit"></span></a>
                                    <a  type="button" class="btn btn-danger" title="Xóa" href="{{route('songs.destroy', $song->id)}}"
                                   onclick="return confirm('Bạn có chắc chắn muốn xóa')"><span class="fas fa-trash"></span></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
